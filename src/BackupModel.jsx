...
const animationGroups = {
  ...
  'pdc3': ['pdc3','pdc3-door1', 'pdc3-door2', 'pdc3-frame'],
  'pdc4': ['pdc4','pdc4-door1', 'pdc4-door2', 'pdc4-frame'],
  'pdc7': ['pdc7','pdc7-door1', 'pdc7-door2', 'pdc7-frame'],
...
export function Model(props) {
  ...
  const [animationState, setAnimationState] = useState(animationGroups);

const playActions = function(objState, intTimeScale){
  console.log(intTimeScale)
  objState.actions.forEach(function(strAction){
  ...
  if(intTimeScale === 1 ){
    setTimeout(function(){
    playActions(objState, -1);
    }, 3000);
  }
}  

  useEffect(() => {
    //playActions(animationGroups['missiles'], 1, true, 1)
    //console.log(actions['pdc1-frame'])
  })
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <directionalLight name="Sun" intensity={2049} decay={2} position={[0, -0.91, 235.38]}>
        ...
        <directionalLight name="Sun001" intensity={204.9} decay={2} position={[-250.65, 0, 0]} rotation={[2.42, -0.07, 0.03]}>
          <group position={[0, 0, -1]} />
        </directionalLight>
        <group name="hull003">
          ...
          <mesh name="hatch-upper" geometry={nodes['hatch-upper'].geometry} material={materials['cw-pe-silver']} 
            onClick={()=>{playActions(animationGroups['gangway'],1)}} />
          <mesh name="missile-door1" geometry={nodes['missile-door1'].geometry} material={materials['cw-pe-silver']} position={[-5.71, 58.51, -40.64]} rotation={[-2.25, 0, 0]} 
            onClick={()=>{playActions(animationGroups['missiles'],1)}} />
          ...
          <mesh name="pdc1-door" geometry={nodes['pdc1-door'].geometry} material={materials['cw-pe-silver']} position={[-36.42, 2.84, -139.52]} rotation={[Math.PI, 0.27, 1.54]} 
            onClick={()=>{playActions(animationGroups['pdc1'],1)}}/>
          ...
          <mesh name="pdc3-housing" geometry={nodes['pdc3-housing'].geometry} material={materials['cw-pe-silver']} position={[-64.56, 0, -16]} rotation={[Math.PI, 0, 0]} scale={-1}>
            ...
            onClick={()=>{playActions(animationGroups['pdc3'],1)}} />
          ...
          <mesh name="pdc4-housing" geometry={nodes['pdc4-housing'].geometry} material={materials['cw-pe-silver']} position={[63.81, 0, -16]}>
            <mesh name="pdc2-door" geometry={nodes['pdc2-door'].geometry} material={materials['cw-pe-silver']} position={[-28.16, 3.15, -123.38]} rotation={[0, 0.27, -1.52]} 
            onClick={()=>{playActions(animationGroups['pdc2'],1)}}/>
            <mesh name="pdc2-door2" geometry={nodes['pdc2-door2'].geometry} material={materials['cw-pe-silver']} position={[-28.16, -9.08, -123.38]} rotation={[0, 0.27, 1.69]} 
            onClick={()=>{playActions(animationGroups['pdc2'],1)}}/>
            <mesh name="pdc2-frame" geometry={nodes['pdc2-frame'].geometry} material={materials['CW-Titanium-shiny']} position={[-122.65, -3.54, -81.08]} rotation={[0, 0.27, 0]}>
            ...
            onClick={()=>{playActions(animationGroups['pdc4'],1)}}/>
          ...
          <mesh name="pdc6-housing" geometry={nodes['pdc6-housing'].geometry} material={materials['cw-pe-silver']} position={[-0.26, 47.47, 105.7]} rotation={[0, 0, Math.PI / 2]}>
            <mesh name="pdc6-door1" geometry={nodes['pdc6-door1'].geometry} material={materials['cw-pe-silver']} position={[3.09, 6.21, 0.04]} rotation={[0, 0, -1.58]} 
            onClick={()=>{playActions(animationGroups['pdc6'],1)}}/>
            <mesh name="pdc6-door2" geometry={nodes['pdc6-door2'].geometry} material={materials['cw-pe-silver']} position={[3.14, -5.62, -0.25]} rotation={[0, 0, 1.57]} 
            onClick={()=>{playActions(animationGroups['pdc6'],1)}}/>
            <mesh name="pdc6-frame" geometry={nodes['pdc6-frame'].geometry} material={materials['CW-Titanium-shiny']} position={[-102.71, 0, 16]}>
